...
import dk.silverbullet.telemed.questionnaire.node.monica.realtime.communicators.OpenTeleCommunicator;
...
public class OpenTeleCommunicatorTest {

    private OpenTeleCommunicator communicator;
    ...
    public void setup() {
        ...
        communicator = new TestOpenTeleCommunicator(new Questionnaire(mock(QuestionnaireFragment.class)), mockApplication);
    }

    @Test
    public void tooManyRequestsExceptionShouldNotBeRetried() throws IOException {
        Exception exception = new HttpResponseException(429, "ERROR");
    ...
    @Test
    public void statusCodesOtherThan429CausesRetries() throws IOException {
    ...
    private class TestOpenTeleCommunicator extends OpenTeleCommunicator {

        public TestOpenTeleCommunicator(Questionnaire questionnaire, OpenTeleApplication openTeleApplication) {
